...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{phd-thesis-main/images/logo/ulisboa-only.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=5cm]{phd-thesis-main/images/logo/ulisboa-only.pdf}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \includegraphics[width=\textwidth]{phd-thesis-main/images/logo/ulisboa-only.pdf}
    \caption{First image}
    \label{fig:sub1}
  \end{subfigure}
  \hfill
